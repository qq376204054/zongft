;(function($){
    $.yhxia.item = {
        ...
        fetch: function(result){
            ...
            $.yhxia.item.fetch_form($('#J_fetch_item'), result.item);
        },
		...
		check_form: function(form){
			form.find('.J_check_btn').die('click').live('click', function(){
                ...
                if(!$.yhxia.util.isURl(item_url)) return $.yhxia.tip({content:lang.please_input+lang.correct_itemurl, icon:'alert'}), !1;
